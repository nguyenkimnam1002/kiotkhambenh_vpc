...
namespace L1_Mini
{
    ...
    {
        public CapSo(bool parent_fullscreen = false)
        {
            InitializeComponent();
        ...
        private string replace_text(string docText, string HoTen, string TheBH, string Muc, string STT)
        {
            ...
            string KIOS_APP_BENHVIEN = RequestHTTP.call_ajaxCALL_SP_S_result("COM.CAUHINH", "KIOS_APP_BENHVIEN");
            docText = docText.Replace("@KIOS_APP_SYT@", KIOS_APP_SYT);
            docText = docText.Replace("@KIOS_APP_BENHVIEN@", KIOS_APP_BENHVIEN);
