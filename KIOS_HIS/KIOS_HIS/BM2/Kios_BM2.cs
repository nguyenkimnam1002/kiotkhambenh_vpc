...
namespace L1_Mini
{
    public partial class Kios_BM2 : Form
    {
        public Kios_BM2(bool parent_fullscreen = false)
        {
            InitializeComponent();

            FormBorderStyle = parent_fullscreen ? FormBorderStyle.None : FormBorderStyle.Sizable;
            TopMost = parent_fullscreen;

            // in_file_stt("Nguyễn Hồng Thị Nguyên", "Mã thẻ BN", "", "BN123123");
        }
        private void Kios_BM2_FormClosed(object sender, FormClosedEventArgs e)
        {
        }

        private void Kios_BM2_Load(object sender, EventArgs e)
        {
        ...
        private bool KiemTra_TheBHYT()
        {
            ...
            // KHI QUET THE BHYT CAC LOAI 575
        ...
        #region CONFIG
        private void Kios_BM2_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void Kios_BM2_FormClosing(object sender, FormClosingEventArgs e)
        {
