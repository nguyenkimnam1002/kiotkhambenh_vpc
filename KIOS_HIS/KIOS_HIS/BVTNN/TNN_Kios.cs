...
{
    public partial class TNN_Kios : Form
    {
        ...
        public TNN_Kios(bool parent_fullscreen = false)
        {
            InitializeComponent();
        ...
        private void TNN_Kios_FormClosing(object sender, FormClosedEventArgs e)
        {
        ...
        private bool in_file_stt(string HoTen, string TheBH, string Muc, string STT, string phankhu, string inchung, string loaiKham, string stt_hientai)
        {
            try
            {
                ...
                using (WordprocessingDocument wordDoc = WordprocessingDocument.Open(OUT_FILE_DOC, true))
                {
                    ...
                    KIOS_HIS.BVTNN.PHIEUIN PHIEUIN = new KIOS_HIS.BVTNN.PHIEUIN(HoTen, TheBH, Muc, STT, phankhu,
        ...
        private string replace_text1(string docText, KIOS_HIS.BVTNN.PHIEUIN PHIEUIN)
        {
        ...
        #region Config
        private void TNN_Kios_KeyDown(object sender, KeyEventArgs e)
        {
