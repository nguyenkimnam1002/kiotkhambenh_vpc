...
using KIOS_HIS.LVVPC;

namespace KIOS_HIS.BVLVVPC
{
    public partial class LVVPC_Kios : Form
    {
        ...
        public LVVPC_Kios(bool parent_fullscreen = false)
        {
            InitializeComponent();
        ...
        {
            LVVPC_Setting setting = new LVVPC_Setting();
            setting.ShowDialog();
        ...
        private void LVVPC_Kios_FormClosing(object sender, FormClosedEventArgs e)
        {
        ...
        private void loadForm()
        {
            int x = 12;
            int y = 74;
            int heightLaySo = 277, heightDangKyKham = 360;
            int margin = 10;

            //int module = Convert.ToInt32(Properties.Settings.Default["Module"]);
            ...
            int module = 0;
            bool showButtonKhamBenh = true;
            bool showButtonKhamHuyetAp = true;
            bool showButtonKhamTieuDuong = true;

            switch (module)
            {
                case 0: //tất cả
                    gbLaySoKhamBenh.Visible = true;
                    gbDangKyKhamBenh.Visible = true;

                    gbLaySoKhamBenh.Location = new Point(x, y);
                    gbLaySoKhamBenh.Size = new Size(gbLaySoKhamBenh.Size.Width, heightLaySo);

                    y += heightLaySo + margin;
                    gbDangKyKhamBenh.Location = new Point(x, y);
                    gbDangKyKhamBenh.Size = new Size(gbLaySoKhamBenh.Size.Width, heightDangKyKham);

                    break;
                case 1: //lấy số khám bệnh
                    gbLaySoKhamBenh.Visible = true;
                    gbDangKyKhamBenh.Visible = false;

                    gbLaySoKhamBenh.Location = new Point(x, y);
                    gbLaySoKhamBenh.Size = new Size(gbLaySoKhamBenh.Size.Width, heightLaySo);

                    break;
                case 2: //đăng ký khám bệnh
                    gbLaySoKhamBenh.Visible = false;
                    gbDangKyKhamBenh.Visible = true;
            ...
            btnKhamMoi.Visible = showButtonKhamBenh;
            btnKhamHuyetAp.Visible = showButtonKhamHuyetAp;
            btnKhamTieuDuong.Visible = showButtonKhamTieuDuong;
        ...
        {
            LaySoKhamBenh("KHAMBENH");
        }


        private void LaySoKhamBenh(string btnCode = "KHAMBENH")
        {
            txtHoTen.Text = "";
            txtMaBN.Text = "";
            ...
            try
            {
                if (btnCode.Equals("KHAMBENH"))
                {
                    btnKhamMoi.Visible = false;
                }

                if (btnCode.Equals("HUYETAP"))
                {
                    btnKhamHuyetAp.Visible = false;
                }

                if (btnCode.Equals("TIEUDUONG"))
                {
                    btnKhamTieuDuong.Visible = false;
                }
                ...
                if (ch_chedo_layso == "1")
                {
                    ...
                    if (dt.Rows.Count > 0 && dt.Columns.Contains("STT"))
                    {
                        ...
                        if (cauhinh_layso_uutien == "1")
                        {
                            ...
                            /*btnKhamMoi.Text = "VÉ THƯỜNG " + String.Format("{0:0000}", stt)*/
                            ;// (stt < 10 ? "0" + stt : "" + stt);
                        ...
                        if (in_file_stt(HoTen, MaBaoHiem, "", dt.Rows[0]["STT"].ToString(), dt.Rows[0]["KHUCHANLE"].ToString(), "1", loaikham, dt.Rows[0]["STTTRUOCDO"].ToString()))
                        {
                            txtMaBN.Text = "";
                            txtHoTen.Text = "";
                            ...
                            lbSTT.Text = "Số tiếp theo: " + stt.ToString();
                            lbSTT.Visible = true;
                        }
                    }
                }
                else
                {
                    ...
                    DataTable dt_temp = RequestHTTP.call_ajaxCALL_SP_O("KBH.CAPSOLAYCT", "0", 0);
                ...
                if (btnCode.Equals("HUYETAP"))
                {
                    btnKhamHuyetAp.Visible = true;
                }

                if (btnCode.Equals("TIEUDUONG"))
                {
                    btnKhamTieuDuong.Visible = true;
                }
        ...
        private void Load_Data()
        {
            ...
            else
            {
                ...
                if (ch_chedo_layso == "1")
                {
                    ...
                    {
                        btnKhamMoi.Text = "KHÁM BỆNH";// + (stt < 10 ? "0" + stt : "" + stt);
                    }
            ...
            try
            {
                ...
                if (ch_chedo_layso == "1")
                {
                    ...
                    if (dt.Rows.Count > 0 && dt.Columns.Contains("STT"))
                    {
                        ...
                        if (in_file_stt(HoTen, MaBaoHiem, "", dt.Rows[0]["STT"].ToString(), dt.Rows[0]["KHUCHANLE"].ToString(), "1", "KHÁM DỊCH VỤ", dt.Rows[0]["STTTRUOCDO"].ToString()))
                        {
                            txtMaBN.Text = "";
                            txtHoTen.Text = "";
                            hideBARCODE_BHYT_LCI = "";
            ...
            try
            {
                ...
                if (ch_chedo_layso == "1")
                {
                    ...
                    if (dt.Rows.Count > 0 && dt.Columns.Contains("STT"))
                    {
                        ...
                        if (in_file_stt(HoTen, MaBaoHiem, "", dt.Rows[0]["STT"].ToString(), dt.Rows[0]["KHUCHANLE"].ToString(), "1", "ƯU TIÊN", dt.Rows[0]["STTTRUOCDO"].ToString()))
                        {
                            txtMaBN.Text = "";
                            txtHoTen.Text = "";
                            hideBARCODE_BHYT_LCI = "";
        ...
        private void btnKhamTieuDuong_Click(object sender, EventArgs e)
        {
            LaySoKhamBenh("TIEUDUONG");
        }
        ...
        private void btnKhamHuyetAp_Click(object sender, EventArgs e)
        {
            LaySoKhamBenh("HUYETAP");
        }

        string hide_STT = "", hide_Benh_An = "", maBN_IN_DNO = "";
        private bool in_file_stt(string HoTen, string TheBH, string Muc, string STT, string phankhu, string inchung, string loaiKham, string stt_hientai)
        {
            try
            {
                ...
                using (WordprocessingDocument wordDoc = WordprocessingDocument.Open(OUT_FILE_DOC, true))
                {
                    ...
                    KIOS_HIS.BVLVVPC.PHIEUIN PHIEUIN = new KIOS_HIS.BVLVVPC.PHIEUIN(HoTen, TheBH, Muc, STT, phankhu,
                                                                                    inchung, loaiKham, stt_hientai, ten_Pkham,
        ...
        private string replace_text1(string docText, KIOS_HIS.BVLVVPC.PHIEUIN PHIEUIN)
        {
        ...
        private void DangKyKham()
        {
            if (dtTT_BenhNhan != null && dtTT_BenhNhan.Rows.Count > 0)
            {
                ...
                //return;
                // Chọn yêu cầu khám
                BVLVVPC_DangKyKham frm = new BVLVVPC_DangKyKham(this.Width, this.Height, this.TopMost);
        ...
        #region Config
        private void LVVPC_Kios_KeyDown(object sender, KeyEventArgs e)
        {
