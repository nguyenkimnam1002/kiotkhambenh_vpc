...
namespace L1_Mini
{
    public partial class BVLVVPC_DangKyKham : Form
    {
        ...
        public BVLVVPC_DangKyKham(int w, int h, bool parent_fullscreen = false)
        {
            InitializeComponent();
        ...
        private void BVLVVPC_DangKyKham_Load(object sender, EventArgs e)
        {
