...
namespace L1_Mini
{
    public partial class BVDAKHOA_KIEU3 : Form
    {
        public BVDAKHOA_KIEU3(bool parent_fullscreen = false)
        {
            InitializeComponent();
        ...
        private void BVDAKHOA_KIEU3_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        string he = "1";  // 0: 
        private void BVDAKHOA_KIEU3_Load(object sender, EventArgs e)
        {
        ...
        private void BVDAKHOA_KIEU3_SizeChanged(object sender, EventArgs e)
        {
            Load_Button();
        }
        ...
        private void BVDAKHOA_KIEU3_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void BVDAKHOA_KIEU3_FormClosing(object sender, FormClosingEventArgs e)
        {
