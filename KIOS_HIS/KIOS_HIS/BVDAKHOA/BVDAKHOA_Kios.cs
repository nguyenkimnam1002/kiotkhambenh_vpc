...
namespace L1_Mini
{
    public partial class BVDAKHOA_Kios : Form
    {
        ...
        private bool in_file_stt(string HoTen, string TheBH, string Muc, string STT, string phankhu, string inchung, string kham_UT, string stt_hientai)
        {
            try
            {
                ...
                using (WordprocessingDocument wordDoc = WordprocessingDocument.Open(OUT_FILE_DOC, true))
                {
                    ...
                    KIOS_HIS.BVDAKHOA.PHIEUIN PHIEUIN = new KIOS_HIS.BVDAKHOA.PHIEUIN(HoTen, TheBH, Muc, STT, phankhu,
        ...
        private string replace_text1(string docText, KIOS_HIS.BVDAKHOA.PHIEUIN PHIEUIN)
        {
