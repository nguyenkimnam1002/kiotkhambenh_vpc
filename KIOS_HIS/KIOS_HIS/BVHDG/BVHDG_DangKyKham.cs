...
namespace L1_Mini
{
    public partial class BVHDG_DangKyKham : Form
    {
        ...
        public BVHDG_DangKyKham(int w, int h, bool parent_fullscreen = false)
        { 
            InitializeComponent(); 
        ...
        private void BVHDG_DangKyKham_Load(object sender, EventArgs e)
        {
            // 0: cong kham => phong kham; 1: chon phong kham truoc, cong kham an theo phong kham; 
