...
namespace L1_Mini
{
    public partial class BVHDG_Kios : Form
    {
        ...
        public BVHDG_Kios(bool parent_fullscreen = false)
        {
            InitializeComponent();
        ...
        private void BVHDG_Kios_Load(object sender, EventArgs e)
        {
        ...
        private void BVHDG_Kios_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private bool in_file_stt(string HoTen, string TheBH, string Muc, string STT, string phankhu, string inchung, string kham_UT, string stt_hientai)
        {
            try
            {
                ...
                using (WordprocessingDocument wordDoc = WordprocessingDocument.Open(OUT_FILE_DOC, true))
                {
                    ...
                    KIOS_HIS.BVHDG.PHIEUIN PHIEUIN = new KIOS_HIS.BVHDG.PHIEUIN(HoTen, TheBH, Muc, STT, phankhu,
        ...
        private string replace_text1(string docText, KIOS_HIS.BVHDG.PHIEUIN PHIEUIN)
        {
        ...
        private void DangKyKham()
        {
            if (dtTT_BenhNhan != null && dtTT_BenhNhan.Rows.Count > 0)
            {
                ...
                //return;
                // Chọn yêu cầu khám
                BVHDG_DangKyKham frm = new BVHDG_DangKyKham(this.Width, this.Height, this.TopMost);
                frm.StartPosition = FormStartPosition.CenterParent;
