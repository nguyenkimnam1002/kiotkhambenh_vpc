...
namespace L1_Mini
{
    public partial class Kios_BND : Form
    {
        public Kios_BND(bool parent_fullscreen = false)
        {
            InitializeComponent();
        ...
        private void Kios_BND_Load(object sender, EventArgs e)
        {
        ...
        private void btnDangKy_Click(object sender, EventArgs e)
        {
            ...
            if (dtTT_BenhNhan != null && dtTT_BenhNhan.Rows.Count > 0)
            {
                ...
                if (dtTT_BenhNhan.Columns.Contains("DTBNID") && dtTT_BenhNhan.Rows[0]["DTBNID"].ToString() == "1")
                {
                    ...
                    if (Const.L1_LoaiBHYT != "" && Const.L1_LoaiBHYT != "0")                        
                    {
        ...
        private bool KiemTra_TheBHYT()
        {
            ...
            // CHECK CONG SAU KHI CHON XONG Y/C KHAM; 
        ...
        #region CONFIG
        private void Kios_BND_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void Kios_BND_FormClosing(object sender, FormClosingEventArgs e)
        {
