...
//
// 2005?: Removed call to Marshal.ReleaseComObject(Crossbar)
//        in Dispose() so AudioSources and VideoSources will
//        not be damaged or thrown away. (HV, 2006)
// ------------------------------------------------------------------
...
namespace VNPT.HIS.CommonForm.Capture
{
    ...
    public class CrossbarSource : Source
    {
        ...
        public override void Dispose()
        {
            ...
            {
                // Bugfix 2005?
                // You can't do this.  It would release the crossbar object
