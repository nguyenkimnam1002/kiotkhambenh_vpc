...
// New:
//  - Audio source was not stored properly, brackets added so
//    the right source is stored for the corresponding stream.
//  - addFromGraph() made public
//
            ...
            for (int cOut = 0; cOut < numOutPins; cOut++)
            {
                ...
                for (int cIn = 0; cIn < numInPins; cIn++)
                {
                    ...
                    if (hr == 0)
                    {
                        ...
                        //#else
                        // This code looks very similar to the previous code. But watch out, this
                        // an example of a typical C pitfall. When using this code instead of the
                        // previous code, you will get a list of audio sources instead of video
                        // sources in Capture.cs ...
                        // This original code have not been removed because you might learn something
                        // from this, I hope.
                        //						if ( connectorType < PhysicalConnectorType.Audio_Tuner )
                        //							if ( isVideoDevice )
                        //								sources.Add( source );
